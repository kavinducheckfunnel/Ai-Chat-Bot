...
STATE_INSTRUCTIONS = {
    ...
    'RECOVERY': (
        ...
        "    EMAIL or PHONE (either one is enough) in one friendly sentence.\n"
        "DON'T:\n"
        "  • Apologize or grovel ('Sorry to bother you…').\n"
        "  • Re-do discovery questions they already answered.\n"
        "  • Insist on BOTH email and phone — one valid contact is enough.\n"
        "  • Let the conversation end without a conversion OR an email/phone "
        "capture attempt."
    ),
    'READY_TO_BUY': (
        "STATE = READY_TO_BUY (high intent, time to close).\n"
        "GOAL: capture the visitor's EMAIL or PHONE (either one is enough — do "
        "NOT insist on both) and close. Do NOT ask for size/delivery/address.\n"
        "DO:\n"
        "  • Confirm the product warmly in ONE sentence.\n"
        "  • Ask for their email or phone number in ONE friendly, natural "
        "sentence — whichever they prefer to share.\n"
