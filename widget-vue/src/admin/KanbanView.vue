...
.refresh-btn:hover { background: rgba(255,255,255,0.04); }
.spin { animation: spin 0.8s linear infinite; }
@keyframes spin { to { transform: rotate(360deg); } }

.loading-state { display: flex; flex-direction: column; align-items: center; gap: 12px; padding: 60px; color: #94A3B8; }
.loader { width: 32px; height: 32px; border: 3px solid rgba(255,255,255,0.08); border-top-color: #6366F1; border-radius: 50%; animation: spin 0.8s linear infinite; }

.kanban-board { display: flex; gap: 14px; flex: 1; overflow-x: auto; padding-bottom: 8px; }

.kanban-col {
  flex: 0 0 240px; background: rgba(255,255,255,0.04); border-radius: 14px;
...
.col-new { background: rgba(255,255,255,0.06); }
...
.col-lost { background: rgba(255,255,255,0.04); }

.col-title { font-size: 13px; font-weight: 700; color: #94a3b8; }
.col-count { background: rgba(255,255,255,0.04); color: #64748B; font-size: 12px; font-weight: 700; padding: 2px 7px; border-radius: 10px; }
...
.kanban-card {
  ...
  border: 1px solid rgba(255,255,255,0.07); cursor: grab; transition: all 0.15s;
...
.heat-bar-wrap { background: rgba(255,255,255,0.06); border-radius: 3px; height: 4px; margin-bottom: 10px; overflow: hidden; }
.heat-bar { height: 100%; border-radius: 3px; transition: width 0.5s; }

.card-client { font-size: 12px; font-weight: 600; color: #f1f5f9; margin-bottom: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
.modal { background: rgba(255,255,255,0.04); border-radius: 16px; width: 100%; max-width: 500px; box-shadow: 0 25px 50px rgba(0,0,0,0.5); }
.modal-header { display: flex; justify-content: space-between; align-items: flex-start; padding: 20px 20px 16px; border-bottom: 1px solid rgba(255,255,255,0.07); }
.modal-header h3 { font-size: 15px; font-weight: 600; color: #f1f5f9; }
.modal-sub { font-size: 12px; color: #94A3B8; }
.modal-body { padding: 20px; }

.modal-meta-row { display: flex; gap: 10px; margin-bottom: 20px; }
.meta-chip { background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.07); border-radius: 8px; padding: 8px 12px; text-align: center; }
...
.move-btn { background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.08); border-radius: 7px; padding: 6px 12px; font-size: 12px; font-weight: 500; color: #475569; cursor: pointer; transition: all 0.15s; font-family: inherit; }
.move-btn:hover { background: rgba(255,255,255,0.08); }
