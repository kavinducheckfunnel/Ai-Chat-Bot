...
.refresh-btn {
  ...
  padding: 8px 14px; font-size: 13px; font-weight: 500; color: var(--cf-text-muted);
  cursor: pointer; transition: all 0.15s; font-family: inherit;
}
.refresh-btn:hover { background: var(--cf-bg-surface); }
.spin { animation: spin 0.8s linear infinite; }
@keyframes spin { to { transform: rotate(360deg); } }

.loading-state { display: flex; flex-direction: column; align-items: center; gap: 12px; padding: 60px; color: var(--cf-text-secondary); }
...
.kanban-col {
  flex: 0 0 240px; background: var(--cf-bg-surface); border-radius: 14px;
...
.col-new { background: var(--cf-bg-ghost); }
.col-engaged { background: rgba(59,130,246,0.12); }
.col-hot { background: rgba(239,68,68,0.08); }
.col-converted { background: rgba(34,197,94,0.08); }
.col-lost { background: var(--cf-bg-surface); }

.col-title { font-size: 13px; font-weight: 700; color: var(--cf-text-secondary); }
.col-count { background: var(--cf-bg-surface); color: var(--cf-text-muted); font-size: 12px; font-weight: 700; padding: 2px 7px; border-radius: 10px; }

.col-cards { flex: 1; overflow-y: auto; padding: 10px; display: flex; flex-direction: column; gap: 8px; }

.kanban-card {
  background: var(--cf-bg-surface); border-radius: 10px; padding: 12px;
  border: 1px solid var(--cf-border-subtle); cursor: grab; transition: all 0.15s;
...
.heat-bar-wrap { background: var(--cf-bg-ghost); border-radius: 3px; height: 4px; margin-bottom: 10px; overflow: hidden; }
.heat-bar { height: 100%; border-radius: 3px; transition: width 0.5s; }

.card-client { font-size: 12px; font-weight: 600; color: var(--cf-text-primary); margin-bottom: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.card-visitor { font-size: 11px; color: var(--cf-text-secondary); font-family: monospace; margin-bottom: 4px; }
...
.card-msgs, .card-time { font-size: 10px; color: var(--cf-text-primary); }

.col-empty { color: var(--cf-text-primary); font-size: 12px; text-align: center; padding: 20px 0; border: 2px dashed #E2E8F0; border-radius: 8px; }
...
.modal { background: var(--cf-bg-surface); border-radius: 16px; width: 100%; max-width: 500px; box-shadow: 0 25px 50px rgba(0,0,0,0.5); }
...
.modal-header h3 { font-size: 15px; font-weight: 600; color: var(--cf-text-primary); }
.modal-sub { font-size: 12px; color: var(--cf-text-secondary); }
.modal-body { padding: 20px; }

.modal-meta-row { display: flex; gap: 10px; margin-bottom: 20px; }
.meta-chip { background: var(--cf-bg-surface); border: 1px solid var(--cf-border-subtle); border-radius: 8px; padding: 8px 12px; text-align: center; }
.meta-k { display: block; font-size: 10px; color: var(--cf-text-secondary); font-weight: 600; text-transform: uppercase; margin-bottom: 2px; }
.meta-v { font-size: 14px; font-weight: 700; color: var(--cf-text-primary); }

.move-label { font-size: 12px; font-weight: 600; color: var(--cf-text-muted); margin-bottom: 10px; }
.move-btns { display: flex; flex-wrap: wrap; gap: 6px; }
.move-btn { background: var(--cf-bg-ghost); border: 1px solid var(--cf-border-default); border-radius: 7px; padding: 6px 12px; font-size: 12px; font-weight: 500; color: var(--cf-text-muted); cursor: pointer; transition: all 0.15s; font-family: inherit; }
.move-btn:hover { background: var(--cf-bg-ghost-hover); }
