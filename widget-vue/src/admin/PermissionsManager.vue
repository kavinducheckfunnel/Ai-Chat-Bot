...
const featureGroups = [
  {
    ...
    features: [
      ...
      { key: 'allow_instagram', label: 'Instagram Direct',  icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#E1306C" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="#E1306C" stroke="none"/></svg>' },
    ],
  },
  {
    label: 'AI & Knowledge',
...
.perm-content { color: var(--cf-text-primary); font-family: 'Inter', -apple-system, sans-serif; }

.page-header { margin-bottom: 24px; }
.page-title { font-size: 22px; font-weight: 700; color: var(--cf-text-primary); letter-spacing: -0.4px; }
.page-sub { font-size: 13px; color: var(--cf-text-muted); margin-top: 4px; }
...
.search-input {
  ...
  border-radius: 8px; padding: 8px 12px; font-size: 13px; color: var(--cf-text-primary); outline: none;
  font-family: inherit;
}
.search-input::placeholder { color: var(--cf-text-muted); }
...
.tenant-row:hover { background: var(--cf-bg-input); }
...
.tenant-name { font-size: 13px; font-weight: 600; color: var(--cf-text-primary); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.tenant-plan { font-size: 11px; color: var(--cf-text-muted); display: flex; align-items: center; gap: 5px; margin-top: 2px; }
...
.no-tenants { padding: 20px; text-align: center; font-size: 13px; color: var(--cf-text-muted); }
.panel-loading { display: flex; justify-content: center; padding: 24px; }
.spinner-sm { width: 22px; height: 22px; border: 2px solid var(--cf-border-default); border-top-color: #6366f1; border-radius: 50%; animation: spin 0.8s linear infinite; }
...
.empty-msg { font-size: 14px; color: var(--cf-text-muted); }

.perms-header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 24px; }
.perms-title { font-size: 18px; font-weight: 700; color: var(--cf-text-primary); }
.perms-sub { font-size: 13px; color: var(--cf-text-muted); margin-top: 4px; }
...
.group-label { font-size: 11px; font-weight: 700; color: var(--cf-text-muted); text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 12px; }
.feat-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 10px; }

.feat-card {
  background: var(--cf-bg-surface-raised); border: 1px solid var(--cf-border-subtle); border-radius: 12px;
...
.feat-icon { width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; background: var(--cf-bg-input); border-radius: 7px; flex-shrink: 0; }
.feat-name { font-size: 13px; font-weight: 600; color: var(--cf-text-primary); }
.feat-source { font-size: 11px; color: var(--cf-text-muted); margin-top: 2px; }
...
.feat-btn {
  ...
  border: 1px solid var(--cf-border-default); background: var(--cf-bg-surface); color: var(--cf-text-muted);
  font-family: inherit; transition: all 0.12s;
}
.feat-btn:hover:not(:disabled) { background: var(--cf-bg-ghost-hover); color: var(--cf-text-secondary); }
...
.feat-override-info { display: flex; gap: 6px; align-items: center; border-top: 1px solid var(--cf-border-subtle); padding-top: 10px; flex-wrap: wrap; }
...
.ov-reason, .ov-expiry {
  ...
  border-radius: 6px; padding: 4px 8px; font-size: 11px; color: var(--cf-text-primary); outline: none;
  font-family: inherit;
}
