...
.admin-container { display: flex; min-height: 100vh; background: var(--cf-bg); color: var(--cf-text); font-family: 'Inter', -apple-system, sans-serif; }
...
.refresh-btn { display: flex; align-items: center; gap: 6px; padding: 7px 14px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 9px; font-size: 12px; color: var(--cf-text-2); cursor: pointer; }
...
.tab-btn { position: relative; display: flex; align-items: center; gap: 7px; padding: 10px 16px; background: none; border: none; border-bottom: 2px solid transparent; font-size: 13px; font-weight: 500; color: var(--cf-text-3); cursor: pointer; margin-bottom: -1px; white-space: nowrap; transition: color 0.12s; }
...
.loading-state { display:flex; align-items:center; gap:12px; padding:60px 0; color:var(--cf-text-3); justify-content:center; font-size:14px; }
...
.rev-label { font-size:11px; font-weight:600; color:var(--cf-text-3); text-transform:uppercase; letter-spacing:0.05em; }
.rev-value { font-size:20px; font-weight:700; color:var(--cf-text); line-height:1.2; }
.rev-sub { font-size:11px; color:var(--cf-text-3); }
...
.chart-header h3 { font-size:14px; font-weight:600; color:var(--cf-text); }
.chart-sub { font-size:11px; color:var(--cf-text-3); }
.line-chart-wrap { display:flex; flex-direction:column; gap:8px; }
.line-chart { width:100%; height:120px; }
.line-labels { display:flex; justify-content:space-between; font-size:11px; color:var(--cf-text-3); padding:0 6px; }
.donut-label-big { font-size:18px; font-weight:700; fill:var(--cf-text); }
.donut-label-sm { font-size:9px; fill:var(--cf-text-3); }
.donut-wrap { display:flex; align-items:center; gap:16px; }
.donut-svg { width:120px; height:120px; flex-shrink:0; }
.donut-legend { display:flex; flex-direction:column; gap:8px; flex:1; }
.legend-row { display:flex; align-items:center; gap:8px; font-size:12px; }
.legend-dot { width:8px; height:8px; border-radius:50%; flex-shrink:0; }
.legend-plan { flex:1; color:var(--cf-text-2); }
.legend-count { color:var(--cf-text); font-weight:600; width:24px; text-align:right; }
...
.stat-mini-label { font-size:11px; color:var(--cf-text-3); text-transform:uppercase; letter-spacing:0.04em; }
.stat-mini-val { font-size:18px; font-weight:700; color:var(--cf-text); }

/* Health board */
.board-controls { display:flex; gap:12px; align-items:center; margin-bottom:16px; flex-wrap:wrap; }
.search-input { background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.1); border-radius:9px; padding:8px 14px; font-size:13px; color:var(--cf-text); width:220px; outline:none; }
.search-input:focus { border-color:rgba(99,102,241,0.4); }
.risk-filters { display:flex; gap:6px; flex-wrap:wrap; }
.risk-pill { padding:5px 12px; border-radius:20px; font-size:12px; font-weight:500; border:1px solid rgba(255,255,255,0.1); background:none; color:var(--cf-text-3); cursor:pointer; transition:all 0.12s; }
...
.health-table th { padding:11px 14px; text-align:left; font-size:11px; font-weight:600; color:var(--cf-text-3); text-transform:uppercase; letter-spacing:0.04em; cursor:pointer; white-space:nowrap; border-bottom:1px solid rgba(255,255,255,0.07); }
.health-table th:hover { color:var(--cf-text-2); }
...
.tenant-name { font-weight:600; color:var(--cf-text); font-size:13px; }
.tenant-email { font-size:11px; color:var(--cf-text-3); }
.plan-badge { padding:3px 8px; border-radius:5px; font-size:11px; font-weight:600; }
.plan-badge.plan-free { background:rgba(71,85,105,0.2); color:var(--cf-text-2); }
...
.stripe-badge.stripe-none, .stripe-badge.stripe-canceled { background:rgba(71,85,105,0.15); color:var(--cf-text-3); }
...
.health-num { font-size:12px; font-weight:600; color:var(--cf-text-2); min-width:24px; }
...
.empty-row { text-align:center; color:var(--cf-text-3); padding:32px; font-size:13px; }
.sort-icon { color:var(--cf-text-3); font-size:10px; }
...
.al-company { font-size:13px; font-weight:600; color:var(--cf-text); }
.al-msg { font-size:12px; color:var(--cf-text-3); }
...
.empty-panel { display:flex; flex-direction:column; align-items:center; gap:12px; padding:60px 0; color:var(--cf-text-3); font-size:14px; }

/* Audit */
.audit-controls { display:flex; gap:10px; margin-bottom:16px; }
.sel-input { background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.1); border-radius:9px; padding:8px 12px; font-size:13px; color:var(--cf-text); }
...
.audit-table th { padding:10px 14px; text-align:left; font-size:11px; font-weight:600; color:var(--cf-text-3); text-transform:uppercase; letter-spacing:0.04em; border-bottom:1px solid rgba(255,255,255,0.07); }
...
.text-muted { color:var(--cf-text-3); }
.small { font-size:11px; }
.actor-badge { padding:2px 7px; background:rgba(99,102,241,0.1); border-radius:4px; color:#a5b4fc; font-size:12px; }
.action-chip { padding:2px 7px; border-radius:4px; font-size:11px; font-weight:600; background:rgba(255,255,255,0.06); color:var(--cf-text-2); }
.audit-pagination { display:flex; align-items:center; gap:12px; padding:12px 16px; justify-content:center; font-size:13px; color:var(--cf-text-3); }
.audit-pagination button { background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); border-radius:7px; padding:5px 12px; color:var(--cf-text-2); cursor:pointer; }
...
.card-title { font-size:15px; font-weight:600; color:var(--cf-text); margin-bottom:18px; }
.form-field { display:flex; flex-direction:column; gap:6px; }
.form-field label { font-size:12px; color:var(--cf-text-3); font-weight:500; }
.form-row { display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-bottom:14px; }
.inp { background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); border-radius:9px; padding:9px 12px; font-size:13px; color:var(--cf-text); font-family:inherit; width:100%; outline:none; }
...
.tips-list li { font-size:13px; color:var(--cf-text-3); line-height:1.5; }
...
.modal { background:var(--cf-surface); border:1px solid rgba(255,255,255,0.1); border-radius:16px; padding:28px; min-width:420px; max-width:92vw; max-height:90vh; overflow-y:auto; }
.modal-wide { min-width:560px; }
.modal-title { font-size:16px; font-weight:700; color:var(--cf-text); margin-bottom:20px; }
.modal-actions { display:flex; justify-content:flex-end; gap:10px; margin-top:20px; }
.btn-ghost { padding:9px 18px; background:none; border:1px solid rgba(255,255,255,0.1); border-radius:9px; font-size:13px; color:var(--cf-text-3); cursor:pointer; }
.btn-ghost:hover { border-color:rgba(255,255,255,0.2); color:var(--cf-text-2); }
...
.ov-reason { color:var(--cf-text-3); flex:1; font-size:11px; }
.ov-exp { color:var(--cf-text-3); font-size:11px; white-space:nowrap; }
