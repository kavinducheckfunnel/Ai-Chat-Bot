...
.page-sub    { font-size: 14px; color: var(--cf-text-2); margin-top: 4px; display: flex; align-items: center; gap: 8px; }
...
.filter-bar {
  ...
  background: var(--cf-surface); border: 1px solid var(--cf-border); border-radius: 12px; padding: 14px 16px;
}

.filter-group { display: flex; flex-direction: column; gap: 5px; }

.filter-label {
  font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.07em; color: var(--cf-text-3);
}

.filter-select, .filter-input {
  height: 36px; border: 1px solid var(--cf-border); border-radius: 8px; padding: 0 10px;
  font-size: 13px; color: #334155; background: var(--cf-surface-3);
  font-family: inherit; outline: none; transition: border-color 0.15s;
}
.filter-select:focus, .filter-input:focus { border-color: #6366F1; background: var(--cf-surface); }
...
.heat-pct { position: absolute; right: 9px; font-size: 12px; color: var(--cf-text-3); pointer-events: none; }
...
.stat-num {
  font-size: 26px; font-weight: 800; color: var(--cf-text); letter-spacing: -0.5px; line-height: 1;
}
...
.stat-lbl {
  font-size: 11px; font-weight: 600; color: var(--cf-text-3); margin-top: 4px; text-transform: uppercase; letter-spacing: 0.05em;
}

/* ── Loading ── */
.loading-state { display: flex; flex-direction: column; align-items: center; gap: 12px; padding: 60px; color: var(--cf-text-3); font-size: 14px; }
...
.empty-icon  { width: 72px; height: 72px; background: var(--cf-surface-3); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 8px; }
.empty-title { font-size: 16px; font-weight: 600; color: #334155; }
.empty-sub   { font-size: 14px; color: var(--cf-text-3); text-align: center; max-width: 360px; }
...
.leads-table thead th {
  ...
  color: var(--cf-text-3); background: var(--cf-surface-3);
...
.lead-row td {
  padding: 13px 16px; border-bottom: 1px solid var(--cf-surface-3);
...
.contact-email { color: var(--cf-text); font-weight: 500; }
.contact-phone { color: var(--cf-text-2); font-size: 12px; margin-top: 3px; }
...
.heat-bar-wrap {
  background: var(--cf-surface-2); border-radius: 3px; height: 3px; margin-top: 5px; overflow: hidden; width: 80px;
}
...
.stage-new       { background: var(--cf-surface-2); color: var(--cf-text-2); }
...
.stage-lost      { background: var(--cf-surface-2); color: var(--cf-text-3); }
...
.date-abs  { display: block; font-size: 11px; color: var(--cf-text-3); margin-top: 2px; }
...
.view-btn:hover { background: #6366F1; color: var(--cf-surface); border-color: #6366F1; }
</style>
