...
.brand-name { font-size: 15px; font-weight: 700; color: var(--cf-text); letter-spacing: -0.3px; }
...
.step-sub { font-size: 14px; color: var(--cf-text-3); line-height: 1.6; margin-top: -16px; }
...
.goal-card {
  ...
  border: 1.5px solid var(--cf-surface-2);
  border-radius: 14px;
  font-size: 15px;
  font-weight: 500;
  color: var(--cf-text-2);
...
.goal-card:hover { border-color: var(--cf-text-3); color: var(--cf-text); background: var(--cf-surface); }
.goal-card.selected { border-color: #6366f1; color: var(--cf-text); background: rgba(99,102,241,0.08); }
...
.url-input::placeholder { color: var(--cf-text-3); }
...
.progress-label { font-size: 13px; color: var(--cf-text-3); }
...
.check-item { display: flex; align-items: center; gap: 9px; font-size: 13px; color: var(--cf-text-3); }
.check-item.done { color: #22c55e; }
.check-circle { width: 14px; height: 14px; border: 1.5px solid var(--cf-text-3); border-radius: 50%; }

/* Fields */
.field { display: flex; flex-direction: column; gap: 8px; }
.field label { font-size: 13px; font-weight: 600; color: var(--cf-text-2); }
.text-input {
  padding: 11px 14px;
  background: var(--cf-surface);
  border: 1.5px solid var(--cf-surface-2);
...
.text-input::placeholder { color: var(--cf-text-3); }
...
.theme-card:hover { border-color: var(--cf-text-3); color: var(--cf-text); }
...
.light-preview { background: var(--cf-text); border: 1px solid var(--cf-text); }
.dark-preview { background: #0f0f1a; border: 1px solid var(--cf-surface-2); }
.preview-bubble { width: 22px; height: 22px; border-radius: 50%; }
.light-bubble { background: var(--cf-surface-2); }
...
.color-hex { font-size: 12px; color: var(--cf-text-3); font-family: monospace; }
...
.btn-next:hover { background: var(--cf-text-3); }
...
.btn-back:hover { color: var(--cf-text-2); }
...
.chat-dark { background: var(--cf-bg); }
...
.chat-dark .greeting-big { color: var(--cf-text); }
.chat-light .greeting-big { color: #0f172a; }

.greeting-sub {
  font-size: 13px; line-height: 1.5;
}
.chat-dark .greeting-sub { color: var(--cf-text-3); }
.chat-light .greeting-sub { color: var(--cf-text-3); }
...
.chat-dark .cta-btn.secondary { color: var(--cf-text-2); border-color: var(--cf-surface-2); }
.chat-light .cta-btn.secondary { color: var(--cf-text-3); border-color: var(--cf-text); background: var(--cf-text); }
</style>
